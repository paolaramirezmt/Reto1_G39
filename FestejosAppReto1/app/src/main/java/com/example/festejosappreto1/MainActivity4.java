...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drawable drawable = res.getDrawable(R.drawable.fiesta, getTheme());

        ImageView imagen4 = (ImageView) findViewById(R.id.imagen4);
        imagen4.setImageDrawable(drawable);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menuopciones4, menu);
        return true;
    }
